...
<body class="bg-white text-dark">
    ...
    <div class="row-md-10 min-vh-100 py-4 bg-light">
        ...
        <ul class="nav nav-tabs border-0 ms-4 me-4 mb-3">
            @foreach ([
                'semua' => 'Semua',
        ...
        <div class="card border-0 shadow-sm mb-3 ms-4 me-4 dokter-card">
            ...
            <div class="row g-3 p-4">
                ...
                <div class="col-md-2 d-flex flex-column align-items-end justify-content-center gap-2">
                    @if($dataPemeriksaan->statusDokter == 'Menunggu Laporan')
                        ...
                        class="btn btn-sm btn-primary d-inline-flex align-items-center justify-content-center gap-1 px-5">
                        <i class="bi bi-upload"></i>
                        <span>Upload File</span>
                        </a>
                    @else
                        <a href="{{ route('dokter.detailpemeriksaan', $dataPemeriksaan) }}"
                        class="btn btn-sm btn-outline-primary d-inline-flex align-items-center justify-content-center gap-1 px-5">
