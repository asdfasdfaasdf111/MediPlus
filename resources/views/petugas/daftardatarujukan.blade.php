  ...
  <div class="container-fluid py-3 py-md-4">
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10 col-xl-8 min-vh-100 d-flex flex-column">
        ...
        {{-- FORM --}}
        <form method="POST"
              action="{{ $draftRujukan ? route('petugas.updateDataRujukan', ['dataPemeriksaan' => $draftData, 'dataRujukan' => $draftRujukan]) : route('petugas.bikinDataRujukan', $draftData) }}" enctype="multipart/form-data" class="bg-white border rounded-4 shadow-sm flex-grow-0">
            @csrf
            @if ($draftRujukan)
                @method('PUT')
            @endif
