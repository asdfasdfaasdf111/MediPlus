  ...
  <div class="container-fluid py-3 py-md-4">
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10 col-xl-8 min-vh-100 d-flex flex-column">
        ...
        {{-- Form --}}
        <form method="POST" action="{{ $draftData ? route('petugas.updateJadwalOnsite', ['dataPemeriksaan' => $draftData]) : route('petugas.bikinDraftOnsite', ['masterPasienId' => $masterPasien->id]) }}" class="bg-white border rounded-4 shadow-sm flex-grow-0">
              ...
              <div class="col-12 col-md-6">
                ...
                <select id="jenisPemeriksaan" name="jenisPemeriksaan" class="form-select rounded-3" required>
                  ...
                  @foreach($rumahSakit->namaJenisPemeriksaan() as $namaJenisPemeriksaan)
                      <option value="{{ $namaJenisPemeriksaan }}" {{ $draftJenisPemeriksaan?->namaJenisPemeriksaan === $namaJenisPemeriksaan ? 'selected' : '' }}>
