...
<head>
    ...
    <title>Petugas | Daftar Ringkasan</title>
  ...
  <div class="container-fluid py-3 py-md-4">
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10 col-xl-8 min-vh-100 d-flex flex-column">
          ...
          <div class="col-12">
            <div class="card shadow-sm">
              <div class="card-header d-flex justify-content-between align-items-center fw-semibold">
                ...
                <a href="{{ route('petugas.daftarpilihjadwal', $masterPasien->user->id) }}" class="btn btn-outline-primary btn-sm rounded-pill">
                  Ubah Jadwal
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-12">
            <div class="card shadow-sm">
              <div class="card-header d-flex justify-content-between align-items-center fw-semibold">
                ...
                <a href="{{ route('petugas.daftartipepasien', $masterPasien) }}" class="btn btn-outline-primary btn-sm rounded-pill"> 
                    Ubah Tipe Pasien 
                </a>
              </div>
              <div class="card-body">
          ...
          <div class="col-12">
            <div class="card shadow-sm">
              <div class="card-header d-flex justify-content-between align-items-center fw-semibold">
                ...
                <a href="{{ route('petugas.daftardatarujukan', $masterPasien) }}" class="btn btn-outline-primary btn-sm rounded-pill">
                  Ubah Data Rujukan
                </a>
              </div>
              <div class="card-body">
        ...
        <form method="POST" action="{{ route('petugas.finalisasiDraft', $dataPemeriksaan) }}" class="mt-4">
            @csrf
            @method('PUT')

            <div class="d-flex justify-content-center gap-3">
                <a href="{{ route('petugas.daftardatarujukan', $masterPasien) }}"  class="btn btn-outline-primary px-5 rounded-pill">
                   Kembali
                </a>
