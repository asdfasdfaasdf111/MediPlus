  ...
  <div class="container-fluid py-3 py-md-4">
    <div class="row justify-content-center">
      <div class="col-12 col-lg-10 col-xl-8 min-vh-100 d-flex flex-column">
        ...
        {{-- FORM  --}}
        <form method="POST" action="{{ route('petugas.updateTipePasien', $draftData) }}" class="bg-white border rounded-4 shadow-sm flex-grow-0">
            @csrf
            @method('PUT')
            ...
            <div class="border-top text-center px-4 py-3">
              <div class="d-inline-flex gap-2">
                <a href="{{ route('petugas.daftarpilihjadwal', $masterPasien->user) }}" class="btn btn-outline-primary px-4 px-md-5 rounded-pill">
                   Kembali
                </a>
