...
<div>
    ...
    <a href="{{ route('petugas.daftartipepasien', $masterPasien) }}"> Ubah Tipe Pasien </a>
</div>
==========================================================
<div>
...
<div>
    ...
    <div></div>
    <a href="{{ route('petugas.daftardatarujukan', $masterPasien) }}"> Ubah Data Rujukan </a>
</div>

<form method="POST" action="{{ route('petugas.finalisasiDraft', $dataPemeriksaan) }}">
    @csrf
    @method('PUT')

    <div class="d-flex justify-content-center gap-3 pt-3">
        <a href="{{ route('petugas.daftardatarujukan', $masterPasien) }}" 
