  ...
  <div class="row justify-content-center">
    <div class="col-12 col-lg-8 col-xl-7">
      <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('petugas.daftartipepasien', $masterPasien) }}" class="btn btn-outline-secondary btn-sm">
      ...
      <form action="{{ route('petugas.bikindatapasienbaru', $masterPasien) }}" method="POST" novalidate>
        @csrf
