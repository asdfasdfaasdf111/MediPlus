    ...
    <div class="col-md-10 p-4 mx-auto">
      ...
      <div class="card shadow-sm">
        ...
        <div class="card-body px-5">
          <form action="{{ route('superadmin.password.update') }}" method="POST" novalidate>
            @csrf
            @method('PUT')
            ...
            <div class="d-flex justify-content-center gap-3 pt-4 pb-4">
              <a href="{{ route('superadmin.homepage') }}" class="btn btn-outline-primary px-5 rounded-pill">Kembali</a>
